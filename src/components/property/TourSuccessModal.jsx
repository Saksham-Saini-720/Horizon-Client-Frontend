    ...
    <>
      ...
      `}>
        ...
        <div className="px-6 py-12 flex flex-col items-center">
          ...
          <p className="text-[15px] text-gray-500 text-center font-inter mb-8 max-w-sm">
          ...
          <div className="w-full space-y-3 mb-8">
            {/* Time Slot */}
            <div className="flex items-center gap-3 text-[15px] text-gray-600 font-inter">
              <svg className="w-5 h-5 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <button
            onClick={onClose}
            className="w-full max-w-xs px-8 py-4 rounded-2xl bg-primary text-white text-[16px] font-semibold font-inter hover:bg-primary-light transition-all shadow-lg"
          >
            Done
          </button>
        </div>

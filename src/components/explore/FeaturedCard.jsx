...
const FeaturedCard = memo(({ id, price, title, location, img }) => {
  ...
  return (
    <div onClick={handleClick} className="flex-shrink-0 w-44 cursor-pointer">
      ...
      {/* Title + Location */}
      <p className="text-[13px] font-semibold text-[#1C2A3A] mt-2 leading-snug font-['DM_Sans',sans-serif] line-clamp-1">
        {title}
      </p>

      ...
      <div className="px-3 pt-2.5 pb-3">
        ...
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-1 min-w-0">
            ...
            <p className="text-[12px] text-gray-500 font-inter truncate">{location}</p>
          </div>
          {rating && (
            <div className="flex items-center gap-0.5 flex-shrink-0 ml-1">
              ...
              <span className="text-[12px] font-semibold text-primary font-inter">{rating}</span>
            </div>
          )}
        </div>

        {/* Title */}
        <p className="text-[15px] font-semibold text-primary font-inter line-clamp-1 mb-1.5">
          {title}
        </p>
        ...
        {(beds || baths || area) && (
          <div className="flex items-center gap-2 mb-2">
            {beds && (
              <span className="flex items-center gap-1 text-[11px] text-gray-500 font-inter">
            ...
            {area && (
              <>
                <span className="text-gray-300 text-[10px]">·</span>
                <span className="text-[11px] text-gray-500 font-inter">{area}</span>
              </>
            )}
          </div>
        )}

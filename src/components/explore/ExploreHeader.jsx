...
const ExploreHeader = memo(({
  ...
  return (
    <>
      <div className="sticky top-0 z-50 bg-secondary backdrop-blur-sm animate-in fade-in duration-300">
        {/* Location row */}
        <div className="flex items-center justify-between px-4 pt-3 pb-2">
          <div className="flex-1 min-w-0 mr-3">
            <p className="text-[12px] font-semibold text-white uppercase tracking-widest leading-none mb-1">
              Your Location
            </p>
            <button 
            ...
            >
              <svg className="w-3.5 h-3.5 text-white flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/>
                <circle cx="12" cy="10" r="3"/>
              </svg>
              <span className="text-[16px] font-semibold text-white font-myriad truncate">

    ...
    >
      ...
      <div className="flex">
        ...
        <div className="relative w-32 h-32 bg-gray-100 flex-shrink-0">
          ...
          {tag && (
            <span
              className={`absolute top-2 left-2 text-[10px] font-semibold px-2.5 py-1 rounded-full font-myriad ${
                tag === 'For Sale'
        ...
        <div className="flex-1 px-4 py-3">
          {/* Price */}
          <p className="text-[18px] font-semibold text-primary font-myriad mb-1">
            {price}
          </p>

          {/* Title */}
          <h3 className="text-[15px] font-semibold text-primary font-myriad mb-1.5 line-clamp-1">
            {title}
          </h3>
          ...
          <div className="flex items-center gap-3 mb-2">
            {beds && (
              <div className="flex items-center gap-1">
                ...
                <span className="text-[12px] text-gray-600 font-myriad">{beds}</span>
              </div>
            )}
            ...
            {baths && (
              <div className="flex items-center gap-1">
                ...
                <span className="text-[11px] text-gray-600 font-myriad">{baths}</span>
              </div>
            )}
            ...
            {area && (
              <div className="flex items-center gap-1">
                ...
                <span className="text-[11px] text-gray-600 font-myriad">{area}</span>
              </div>
            )}
          </div>

          {/* Timestamp */}
          <p className="text-[10px] text-gray-400 font-myriad">
          ...
          {isEditing ? (
            ...
            <>
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl border-2 border-secondary bg-amber-50/50 text-[15px] text-gray-700 font-myriad placeholder-gray-400 focus:outline-none focus:border-secondary resize-none transition-colors"
                rows={4}
                maxLength={500}
                autoFocus
              />
              ...
              <div className="flex items-center justify-between mt-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-primary text-white text-[15px] font-semibold hover:bg-primary-light font-myriad transition-colors"
                  >
                    Save Note
                  </button>
                </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="text-[15px] text-gray-600 font-myriad leading-relaxed flex-1">
                {note}
              </p>
            </div>
          )}
      ...
      >
        ...
        >
          <div className="flex items-center gap-1.5 text-[15px] font-semibold text-gray-500 hover:text-primary font-myriad transition-colors">
            <svg 
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center py-3 hover:bg-gray-50 transition-colors"
        >
          <div className="flex items-center gap-1.5 text-[15px] font-semibold text-red-500 hover:text-red-600 font-myriad transition-colors">
            <svg
              className="w-3.5 h-3.5"
              viewBox="0 0 24 24"
              fill="none"

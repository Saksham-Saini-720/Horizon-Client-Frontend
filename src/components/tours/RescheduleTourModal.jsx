        ...
        <form onSubmit={handleSubmit} className="px-6 py-6">
          ...
          <div className="mb-5 p-4 rounded-xl bg-blue-50 border border-blue-100">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-[13px] font-semibold text-blue-800 font-['DM_Sans',sans-serif] mb-1">
                  Choose New Date & Time
                </p>
                <p className="text-[12px] text-blue-700 font-['DM_Sans',sans-serif]">
          ...
          {tour?.status === 'confirmed' && tour?.date && (
            <div className="mb-5 p-3 rounded-xl bg-gray-50 border border-gray-100">
              <p className="text-[11px] text-gray-500 font-['DM_Sans',sans-serif] mb-1">
                Current Schedule:
              </p>
              <p className="text-[13px] font-semibold text-gray-700 font-['DM_Sans',sans-serif]">
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              <input
                ...
                required
                disabled={rescheduleMutation.isPending}
                className="w-full px-4 py-3 rounded-xl border border-gray-200 text-[14px] text-gray-800 font-['DM_Sans',sans-serif] focus:outline-none focus:border-[#1C2A3A] focus:ring-2 focus:ring-[#1C2A3A]/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              />
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 rounded-xl bg-amber-500 text-white text-[14px] font-semibold font-['DM_Sans',sans-serif] hover:bg-amber-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >

      ...
      <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
        ...
        <div className="p-5 flex items-center gap-4">
          ...
          <div className="flex-1">
            <p className="text-[14px] font-semibold text-[#1C2A3A] font-['DM_Sans',sans-serif]">
              This Device
            </p>
        ...
        >
          ...
          <span className="flex-1 text-[14px] font-semibold text-[#1C2A3A] font-['DM_Sans',sans-serif]">
            Log Out
          </span>
          <svg 
        ...
        >
          ...
          <span className="flex-1 text-[14px] font-semibold text-red-600 font-['DM_Sans',sans-serif]">
            Request Account Deletion
          </span>
          <svg 
            className="w-5 h-5 text-red-300 group-hover:text-red-400 transition-colors" 
            viewBox="0 0 24 24" 
            fill="none" 
            stroke="currentColor" 
            strokeWidth="2"

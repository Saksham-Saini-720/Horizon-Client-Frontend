 ...
 * DYNAMIC VERIFIED BADGE - Shows verified/not verified based on user.verified
 */
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        <div className="relative">
          {user?.profileImage ? (
            ...
            <div className="w-20 h-20 rounded-full bg-gradient-to-br from-secondary to-primary-light flex items-center justify-center text-white text-[24px] font-semibold font-myriad shadow-lg">
        ...
        <div className="flex-1">
          <h2 className="text-[20px] font-semibold text-primary font-myriad mb-3">
          ...
          {user?.phone && (
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[15px] text-gray-600 font-myriad">
                {user.phone}
              </span>
              {user.verified && (
          ...
          {user?.verified ? (
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-green-50 border border-green-200">
              ...
              <span className="text-[12px] font-semibold text-green-600 font-myriad">
                Verified Account
              </span>
            </div>
          ) : (
            // NOT VERIFIED - Amber/Orange Badge
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-amber-50 border border-amber-200">
              ...
              <span className="text-[12px] font-semibold text-amber-600 font-myriad">
                Not Verified
              </span>
            </div>
          )}

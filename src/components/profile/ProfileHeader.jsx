...
const ProfileHeader = memo(({ user, onEdit }) => {
  ...
  return (
    <div className="bg-white mt-6 px-6 rounded-3xl mb-6 shadow-lg">
      {/* User Info Card */}
      <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl pb-4 pt-2 mb-6">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div className="relative">
            {user?.profileImage ? (
              ...
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-primary-light flex items-center justify-center text-white text-[24px] font-black font-playfair shadow-lg">
          ...
          <div className="flex-1">
            <h2 className="text-[20px] font-black text-primary font-playfair mb-3">
        ...
        <button
          onClick={onEdit}
          className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white border border-gray-200 text-gray-700 hover:border-amber-400 hover:bg-amber-50 hover:text-amber-600 transition-all group"
        >
          <svg

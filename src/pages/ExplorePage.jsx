...
// src/pages/ExplorePage.jsx - FIXED NEARBY MODE
import { useState, useCallback, useMemo, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import useRecentSearches from "../hooks/searches/useRecentSearches";
import useSearchSubmit from "../hooks/utils/useDebounceSearch";
...
const ExplorePage = () => {
  ...
  // ⭐ Apply frontend filters to nearby properties
  ...
  // ⭐ Featured: use FeaturedCard (horizontal scroll)
  const featuredData = showNearby ? [] : featuredQuery.data;
  
  // ⭐ Nearby: use filtered data for vertical NewListingCard display
  const nearbyData = filteredNearbyData;
  
  // ⭐ New Listings: object with properties and pagination
  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <div className="pb-28">
        ...
        {/* ⭐ Featured Section (NO NEARBY MODE) */}
        {!showNearby && (
          <div className="mt-4 mb-6">
            <SectionHeader
              title="Featured"
        ...
        {/* ⭐ Nearby Properties Section (VERTICAL NEWLISTINGCARD) */}
        {showNearby && (
